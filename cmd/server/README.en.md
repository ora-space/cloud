...
See [cmd overview](../README.en.md), [HTTP router](../../internal/api/router/README.en.md), [Authentication](../../docs/authentication.md), and [Core contract](../../docs/core-contract.md).
