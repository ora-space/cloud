...
- [migrations](migrations/README.md) defines the forward-only, linear PostgreSQL schema migration scripts and checksum verification.
...
See [Database migrations](migrations/README.md), [Core contract](../../docs/core-contract.md), and [Authentication](../../docs/authentication.md).
