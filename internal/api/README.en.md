...
- [router](router/README.en.md) configures the Gin HTTP engine, registers routes, verifies caller credentials, parses request bodies with strict limits, and maps domain errors to public fault contracts.
...
See [HTTP router](router/README.en.md), [Contract package](../contract/README.en.md), and [API specification](../../api/openapi.json).
